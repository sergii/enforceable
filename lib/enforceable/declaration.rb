...
module Enforceable
  Declaration = Struct.new(:rule, :scope, :scope_options, keyword_init: true)
  ...
  module DeclarationMethods
    ...
    def enforceable(rule, scope:, scope_options: {})
      (@enforceable_declarations ||= []) << Enforceable::Declaration.new(rule: rule.to_sym, scope: scope.to_sym,
